...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, MCU_RL1_Pin|MCU_RL2_Pin|MCU_RL3_Pin|MCU_RS_Pin
                          |LED_STATUS_Pin|LED_RUN_Pin|LED_WARNING_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PBPin PBPin PBPin PBPin
                           PBPin PBPin PBPin */
  GPIO_InitStruct.Pin = MCU_RL1_Pin|MCU_RL2_Pin|MCU_RL3_Pin|MCU_RS_Pin
                          |LED_STATUS_Pin|LED_RUN_Pin|LED_WARNING_Pin;
