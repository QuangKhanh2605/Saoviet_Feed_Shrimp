...
/*======= Define Type SIM: SIM_L511 LIB =============*/  
    ...
    #define SIM_GET_AT_CMD(sim_step)                    L508_Get_AT_Cmd(sim_step) 
     
    #define SIM_CHECK_STEP_LONG_TIMEOUT(sim_step)       L508_Check_Step_Long_Timeout(sim_step)
    #define SIM_TYPE_DELAY_2_STEP(sim_step)             L508_Get_Delay_2_AT(sim_step)    
    #define SIM_IS_STEP_CHECK_URC(sim_step)             L508_Is_Step_Check_URC(sim_step)  
    #define SIM_IS_STEP_SKIP_ERROR(sim_step)            L508_Check_Step_Skip_Error(sim_step) 
#endif
