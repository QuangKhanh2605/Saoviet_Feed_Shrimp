...
#define FLASH_ADDR_GPS_A_STOP			0x4F26FF		//Sector 1266	699 sector = 2796 record (x 1024 byte) = 11184 record (x256 byte)

#define FLASH_ADDR_GPS_B_START 			0x4F4000		//Sector 1268		
#define FLASH_ADDR_GPS_B_STOP			0x7AF6FF		//Sector 1967	699 sector = 2796 record (x 1024 byte) = 11184 record (x256 byte)

#define FLASH_ADDR_GPS_OFFSET   		0x2BD000        // FLASH_ADDR_GPS_B_START -  FLASH_ADDR_GPS_A_START = 
