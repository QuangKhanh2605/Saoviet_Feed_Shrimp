...
uint16_t HW_AdcReadChannel (uint32_t Channel)
{
    ...
    #if defined (STM32L433xx) || defined (STM32L452xx) || defined (STM32L151xC) || defined (STM32L496xx)
...
uint16_t ADC_Convert_Vol_To_Percent (uint32_t Vol_mV, uint32_t VMAX, uint32_t VMIN)
{
