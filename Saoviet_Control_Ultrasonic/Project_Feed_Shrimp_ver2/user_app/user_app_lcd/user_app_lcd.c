...
uint8_t aState_Bom[17]          = {"Bom Nuoc        "};
uint8_t aState_Xa[17]           = {"Xa Nuoc         "};
uint8_t aState_Ultrasonic[17]   = {"Ultrasonic      "};
...
LCD_Char_Display                    oLCD_C_Main_1[]=
{
  ...
  {_LCD_C_MAIN_1_RUN,           0,1,0,          (uint8_t*)"Bom  :      Giay"},
  {_LCD_C_MAIN_1_FREE,          0,1,0,          (uint8_t*)"Xa   :      Giay"},
  {_LCD_C_MAIN_1_CYCLE,         0,1,0,          (uint8_t*)"Ultra:      Giay"}
};
...
LCD_Char_Display                    oLCD_C_Main_2[]=
{
  ...
  {_LCD_C_MAIN_2_RUN,           0,1,0,          (uint8_t*)"Bom  :      Giay"},
  {_LCD_C_MAIN_2_FREE,          0,1,0,          (uint8_t*)"Xa   :      Giay"},
  {_LCD_C_MAIN_2_CYCLE,         0,1,0,          (uint8_t*)"Ultra:      Giay"},
};
